...
void EmptyLinkFunctionForGeneratedCodeMapboxLandscape_init() {}
static_assert(!UE_WITH_CONSTINIT_UOBJECT, "This generated code can only be compiled with !UE_WITH_CONSTINIT_OBJECT");	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_MapboxLandscape;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MapboxLandscape()
	{
		if (!Z_Registration_Info_UPackage__Script_MapboxLandscape.OuterSingleton)
		{
		static const UECodeGen_Private::FPackageParams PackageParams = {
			"/Script/MapboxLandscape",
			nullptr,
			0,
